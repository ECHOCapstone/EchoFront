            ...
            <div className="space-y-3">
              ...
              {track.chapters.map((chapter, index) => (
                <button
                  ...
                  className="w-full text-left bg-white border-2 border-gray-200 hover:border-brand-500 hover:bg-brand-50 rounded-2xl p-4 transition-colors flex items-center gap-4"
                >
