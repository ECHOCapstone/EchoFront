...
import TrackMap from './learning/TrackMap';
import { tracksApi } from '../api';
import { useApiResource } from '../hooks/useApiResource';
import { paths } from '../lib/paths';
import { completedChapters, trackProgressRatio } from '../lib/trackProgress';
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <h2 className="text-lg font-bold text-gray-900 mb-1">학습 경로</h2>
                  {total === 0 ? (
                    <p className="text-gray-500">이 트랙에는 아직 챕터가 없습니다.</p>
                  ) : (
                    <TrackMap trackId={track.id} chapters={track.chapters} onEnter={enterChapter} />
                  )}
                </>
              );
            })()}
