...
const RULES: Rule[] = [
  ...
  { keywords: ['콘텐츠', '동영상', '영상', '편집', '유튜브', '촬영', '제작'], visual: { Icon: Clapperboard, bg: 'bg-lime-100', fg: 'text-lime-600' } },
  ...
  { keywords: ['교통', '대중교통', '택시', '운전', '도로'], visual: { Icon: Car, bg: 'bg-lime-100', fg: 'text-lime-600' } },
