...
const KOREAN_ERROR_MESSAGES: Record<string, string> = {
  ...
  OAUTH_ACCOUNT_ALREADY_LINKED: '이미 다른 사용자에게 연결된 소셜 계정입니다.',
  ...
  SCRIPT_NOT_FOUND: '존재하지 않는 학습입니다.',
  STEP_NOT_FOUND: '존재하지 않는 학습 단계입니다.',
  SESSION_NOT_FOUND: '존재하지 않는 세션입니다.',
  SESSION_SENTENCE_NOT_FOUND: '존재하지 않는 문장입니다.',
  RECORDING_NOT_FOUND: '존재하지 않는 녹음입니다.',
  FEEDBACK_NOT_FOUND: '존재하지 않는 피드백입니다.',
  PHONEME_ASSET_NOT_FOUND: '음소 이미지가 등록되어 있지 않습니다.',
  TRACK_NOT_FOUND: '존재하지 않는 트랙입니다.',
